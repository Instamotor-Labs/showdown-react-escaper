...
(function () {
  ...
  var showdown = require('showdown'),
    reactEscaper = require('../src/showdown-react-escaper.js'),
    fs = require('fs'),
  ...
  // Test cases
  //
  describe('Showdown React Escaper Extension cases testcase', function () {
  ...
  describe('Showdown React Escaper Extension issues testcases', function () {
    var converter = new showdown.Converter({extensions: [reactEscaper]})
